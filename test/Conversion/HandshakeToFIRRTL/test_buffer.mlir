...
// CHECK:   %validReg0 = firrtl.regreset %clock, %reset, %c0_ui1 : !firrtl.clock, !firrtl.uint<1>, !firrtl.const.uint<1>, !firrtl.uint<1>
...
// CHECK:   %validReg1 = firrtl.regreset %clock, %reset, %c0_ui1 : !firrtl.clock, !firrtl.uint<1>, !firrtl.const.uint<1>, !firrtl.uint<1>
...
// CHECK:   %validReg2 = firrtl.regreset %clock, %reset, %c0_ui1 : !firrtl.clock, !firrtl.uint<1>, !firrtl.const.uint<1>, !firrtl.uint<1>
...
// CHECK:   %c0_ui64 = firrtl.constant 0 : !firrtl.const.uint<64>

// CHECK:   %dataReg0 = firrtl.regreset %clock, %reset, %c0_ui64 : !firrtl.clock, !firrtl.uint<1>, !firrtl.const.uint<64>, !firrtl.uint<64>
...
// CHECK:   %dataReg1 = firrtl.regreset %clock, %reset, %c0_ui64 : !firrtl.clock, !firrtl.uint<1>, !firrtl.const.uint<64>, !firrtl.uint<64>
...
// CHECK: %validReg0 = firrtl.regreset %clock, %reset, %c1_ui1  : !firrtl.clock, !firrtl.uint<1>, !firrtl.const.uint<1>, !firrtl.uint<1>
// CHECK: %dataReg0 = firrtl.regreset %clock, %reset, %c42_ui64  : !firrtl.clock, !firrtl.uint<1>, !firrtl.const.uint<64>, !firrtl.uint<64>
...
// CHECK: %[[VALUE:.*]] = firrtl.constant 0 : !firrtl.const.sint<64>
// CHECK: %[[ZERO_BUNDLE:.*]] = firrtl.bitcast %[[VALUE]] : (!firrtl.const.sint<64>) -> !firrtl.bundle<field0: uint<32>, field1: uint<32>>
...
// CHECK: %[[C1:.*]] = firrtl.constant 1 : !firrtl.const.uint<1>
// CHECK: %validReg0 = firrtl.regreset  %clock, %reset, %[[C1]]  : !firrtl.clock, !firrtl.uint<1>, !firrtl.const.uint<1>, !firrtl.uint<1>
